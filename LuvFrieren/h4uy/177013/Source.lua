...
function Library:GetColor(color, table)
    ...
    if (color.R == nil) then return Color3.fromRGB(147, 112, 219) end
...
function Library:CreateWindow(title, color)
    title = title or "Zenith HUB | EVO"
    color = color and Library:GetColor(color) or Color3.fromRGB(147, 112, 219)
    ...
    core.Size = UDim2.new(0, 531, 0, 531)
